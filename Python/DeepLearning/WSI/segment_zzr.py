...
All_start = time.time()
deploy = '/home/zzr/Data/Skin/script_6_class/deploy.prototxt'
mean = '/home/zzr/Data/Skin/script_6_class/mean.npy'
model = '/home/zzr/Data/Skin/script_6_class/model/_iter_2000.caffemodel'
...
img_WSI_all = []
img_WSI_all.append(os.path.join(img_WSI_dir, '2018-06-06 16.14.09.ndpi'))#train:2018-06-06 15.14.49.ndpi 2018-06-06 16.14.09.ndpi#test:2018-06-06 15.15.56.ndpi
        ...
        for k in range(nbatch):
            ...
            for tdx in idx:
                ...
                img_tmp = skimage.img_as_float(
                    np.array(slide.read_region((224 * i, 224 * tdx), 0, (224, 224)))).astype(np.float32)[..., 0:-1]
