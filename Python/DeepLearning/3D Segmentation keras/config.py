...
config["train_data_path"] = '/media/zzr/Data/Task07_Pancreas/Game/preprocess1/img'
config["train_seg_path"] = '/media/zzr/Data/Task07_Pancreas/Game/preprocess1/label'
config["test_img_path"] = '/media/zzr/Data/Task07_Pancreas/TCIA/preprocess1/img'
config["test_seg_path"] = '/media/zzr/Data/Task07_Pancreas/TCIA/preprocess1/label'
