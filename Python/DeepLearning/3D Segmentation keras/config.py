...
config["train_data_path"] = '/media/zzr/Data/Task07_Pancreas/preprocess/caffe_data/image'
config["train_seg_path"] = '/media/zzr/Data/Task07_Pancreas/preprocess/caffe_data/label'
config["resume"] = False
