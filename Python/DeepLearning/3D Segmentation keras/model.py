...
def Nest_Net(shape, classes=1, deep_supervision=True):
    ...
    pool4 = MaxPooling3D(2, strides=2, name='pool4')(conv4_1)
    ...
    up4_2 = Conv3DTranspose(nb_filter[3], 2, strides=2, name='up42', padding='same')(conv5_1)
    conv4_2 = concatenate([up4_2, conv4_1], name='merge42')
    conv4_2 = standard_unit(conv4_2, stage='42', nb_filter=nb_filter[3])

    up3_3 = Conv3DTranspose(nb_filter[2], 2, strides=2, name='up33', padding='same')(conv4_2)
    conv3_3 = concatenate([up3_3, conv3_1, conv3_2], name='merge33')
    conv3_3 = standard_unit(conv3_3, stage='33', nb_filter=nb_filter[2])

    up2_4 = Conv3DTranspose(nb_filter[1], 2, strides=2, name='up24', padding='same')(conv3_3)
    conv2_4 = concatenate([up2_4, conv2_1, conv2_2, conv2_3], name='merge24')
    conv2_4 = standard_unit(conv2_4, stage='24', nb_filter=nb_filter[1])

    up1_5 = Conv3DTranspose(nb_filter[0], 2, strides=2, name='up15', padding='same')(conv2_4)
    ...
    nestnet_output_1 = Conv3D(classes, 1, activation='sigmoid', name='output_1',
                              kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(l2_ratio))(conv1_2)
    nestnet_output_2 = Conv3D(classes, 1, activation='sigmoid', name='output_2',
                              kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(l2_ratio))(conv1_3)
    nestnet_output_3 = Conv3D(classes, 1, activation='sigmoid', name='output_3',
                              kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(l2_ratio))(conv1_4)
    nestnet_output_4 = Conv3D(classes, 1, activation='sigmoid', name='output_4',
                              kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(l2_ratio))(conv1_5)
    ...
    print 'nestnet_output_4 shape:', nestnet_output_4.shape
    ...
    model.compile(optimizer=Adam(lr=config["initial_learning_rate"]),
                  loss=[dice_coef_loss, dice_coef_loss, dice_coef_loss, dice_coef_loss],
                  metrics={'output_1': dice_coef, 'output_2': dice_coef, 'output_3': dice_coef, 'output_4': dice_coef})
    return model
