function stats = nFold_LDA_v2(data_set,data_labels,shuffle,n,nIter,para,Subsets)
...
for j=1:nIter
    ...
    for i=1:n
        ...
        [temp_stats,methodstring] = Classify( 'LDA', training_set , testing_set, training_labels(:), testing_labels(:));
