function stats = nFold_QDA(data_set,data_labels,shuffle,n,nIter,Subsets)
...
for j=1:nIter
    ...
    for i=1:n
        ...
        [temp_stats,methodstring] = Classify( 'QDA', training_set , testing_set, training_labels(:), testing_labels(:));
