function stats = nFold_NaiveBayes(data_set,data_labels,shuffle,n,nIter,Subsets,varargin)
% Using n-fold subset selection and naive Bayes classifier
% Input:
%   data_set: data
%   data_labels: labels
...
%   Subsets: pass your own training and testing subsets & labels (Default: computer will generate using 'nFold')
%   varargin: optional arguments will be passed directly to classifier
%
% Output:
...
for j=1:nIter
    ...
    for i=1:n
        ...
        [temp_stats,methodstring] = Classify( 'NBayes', training_set , testing_set, training_labels, testing_labels, varargin);
