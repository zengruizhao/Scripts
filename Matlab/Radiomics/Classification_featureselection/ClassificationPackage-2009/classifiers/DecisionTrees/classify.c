...
/* IPA[022503] - BEGIN */
/* I am repeating the definition so that I can call from besttree.c, line 402,
   and get the probability by resetting the verbosity level, line 80 */

ClassNo Category_IPA(CaseDesc, DecisionTree) 
/*       --------  */
    Description CaseDesc; 
    Tree DecisionTree; 
{ 
