function [methodstring,stats] = glm( training_set , testing_set, training_labels, testing_labels)

methodstring = 'linear regression';

mdl = fitglm(training_set, training_labels); 
probs = predict(mdl, testing_set);

stats.prediction = single(probs);
