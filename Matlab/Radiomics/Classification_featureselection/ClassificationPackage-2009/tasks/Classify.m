...
% if ismember(lower(type),{'baggedc45','svm','onevsone_baggedc45','baggedc45_notraining',...
%         'baggedc45_notraining_multiclass','baggedc45_multiclass','nbayes','nbayes_notraining','qda','lda'})
%     [methodstring,stats]=feval(type, varargin{:});
% else
